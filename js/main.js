...
var countdown = function() {
	...
	var countDownDate = new Date("2026-06-27T10:00:00").getTime();
	...
	var interval = setInterval(function() {
		...
		if (distance < 0) {
			...
			$('#countdown').html('🎉 Festival už začal 🔥');
			return;
		}
		...
		update('cd-days', days);
		update('cd-hours', pad(hours));
		update('cd-minutes', pad(minutes));
		update('cd-seconds', pad(seconds));
